...
public class LoadLevel : MonoBehaviour
{
    ...
    {
        return Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "/Macabre/" + PlayerPrefs.GetString("LastLoadedLevel");
    }
    public static string LevelFolder()
    {
        return Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "/Macabre/";
    }
    ...
    void LoadTheLevel()
    {
        string[] lines = File.ReadAllText(LevelPath()).Split('|');
